package com.javasm.salesupply.config;

import com.javasm.salesupply.common.http.EnumStatus;
...
public class Swagger2Configuration {
    //api接口包扫描路径
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.javasm.salesupply";
