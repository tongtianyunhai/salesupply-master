...
@ApiModel(value="SpReturnwarehouse对象", description="返厂入库表")
public class SpReturnwarehouse implements Serializable {


    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "返厂入库申请单编号")
    @TableId(value = "sp_orderid", type = IdType.AUTO)
    private Integer spOrderid;

    @ApiModelProperty(value = "申请类型（返厂出库 3）")
    ...
    @ApiModelProperty(value = "返厂入库状态 已入库:1 未入库:0） ")
    private Integer spInstatus;

    @ApiModelProperty(value = "返厂入库单号")
    private String spInorderid;
